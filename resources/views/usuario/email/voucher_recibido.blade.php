                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td dir="ltr" style="padding: 0 10px 10px 10px;">
                                    <img src="https://png.icons8.com/dotty/250/004A99/payment-history.png" width="200" height="" border="0" alt="Verificar cuenta" class="center-on-narrow" style="width: 100%; max-width: 200px; height: auto; background: #fff; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555;">
                                </td>
                            </tr>
                        </table>
                      </div>
