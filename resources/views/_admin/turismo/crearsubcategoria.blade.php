...
@section('contenido')
    <div class="card">
        <div class="card-header">
            Agregar nueva subcategoría en la sección turística
        </div>
        <div class="card-body">
            <form action="{{ url('/admin/subcategorias-turismo') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-horizontal col-sm-8 offset-sm-2">
                	...
                	<div class="form-group row">
                        ...
                        <div class="col-md-9">
                            {!! Form::select('turismo_categoria_id',$categorias,null,['class'=>"form-control select2". ($errors->has('turismo_categoria_id') ? ' is-invalid' : ''),'placeholder' => 'Seleccione...',"required"=>""]) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control{{ $errors->has('subcategoria') ? ' is-invalid' : '' }}" value="{{ old('subcategoria') }}" id="subcategoria" name="subcategoria" placeholder="Ingrese el nombre de la subcategoría." required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            <h6>Previsualización:</h6><img id="img-imagen" src="/assets/img/avatars/img.jpg" style="width:500px;height:166px;" alt="Previsualización" class="img-responsive">
                        </div>
                    </div>
