...
@section('contenido')
    ...
    <div class="card">
        <div class="card-header">
            Situación de la empresa <strong>{{ $empresa->razon_social }} </strong>
        </div>
        <div class="card-body">
                        ...
                        @if ($empresa)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif($empresa->aprobado==1)
                                        <a class="btn btn-sm btn-success" href="/admin/lista-empresa/{{ $empresa->id }}/edit" target="_blank">Aprobado</a>
                                    @else
                                        <a class="btn btn-sm btn-danger" href="/admin/lista-empresa/{{ $empresa->id }}/edit" target="_blank">Rechazado</a>
                                    @endif
                                </td>
                            </tr>
