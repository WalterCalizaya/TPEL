                      	...
                      	<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                      		<tr>
                      			<td dir="ltr" style="padding: 0 10px 10px 10px;">
                      				<img src="https://png.icons8.com/wired/250/004A99/lock-2.png" width="200" height="" border="0" alt="Verificar cuenta" class="center-on-narrow" style="width: 100%; max-width: 200px; height: auto; background: #ffffff; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555;">
                      			</td>
                      		</tr>
                      	</table>
                      </div>
                      				...
                      				<table role="presentation" cellspacing="0" cellpadding="0" border="0" class="center-on-narrow" style="float:left;">
                      					<tr>
                      						<td class="button-td button-td-primary" style="border-radius: 4px; background: #f7b543;">
                      							<a class="button-a button-a-primary" href="{{ url('/password/reset/'.$token) }}" style="background: #f7b543; border: 1px solid #d29428; font-family: sans-serif; font-size: 15px; line-height: 15px; text-decoration: none; padding: 13px 17px; color: #000000; display: block; border-radius: 4px;">Restablecer contraseña</a>
                      						</td>
                      					</tr>
                      				</table>
                      				<!-- Button : END -->
