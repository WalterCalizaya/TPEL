...
<head>
	...
	<title>Por favor, confirma tu registro en Tu Profe en Línea</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
...
.button-a-primary:hover {
	background: #d29428 !important;
	border-color: #ac7310 !important;
}
    ...
    <!-- Preview Text Spacing Hack : END -->
        ...
        <!--
          ...
          <div style="max-width: 680px; margin: 0 auto;" class="email-container">
            ...
            <!-- Email Body : BEGIN -->
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 0 auto; background: #004A99;">
            	<!-- Email Header : BEGIN -->
            	<tr>
            	...
            	<tr>
            		...
            		<td dir="rtl" height="100%" valign="top" width="100%" style="padding: 10px 0; background-color: #fff;">
                  <!--[if mso]>
                      	...
                      	<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                      		<tr>
                      			<td dir="ltr" style="padding: 0 10px 10px 10px;">
                      				<img src="https://png.icons8.com/dotty/250/004A99/id-verified.png" width="200" height="" border="0" alt="Verificar cuenta" class="center-on-narrow" style="width: 100%; max-width: 200px; height: auto; background: #fff; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555;">
                      			</td>
                      		</tr>
                      	</table>
                      </div>
                      	...
                      	<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                      		<tr>
                      			<td dir="ltr" style="font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555; padding: 10px 10px 0; text-align: left;" class="center-on-narrow">
                      				<h2 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 18px; line-height: 22px; color: #333333; font-weight: bold;">¡Gracias por registrarte!</h2>
                      				<p style="margin: 0 0 10px 0;">Antes de iniciar sesión debes verificar tu cuenta haciendo clic en el siguiente enlace:</p>
                      				<!-- Button : BEGIN -->
                      				<table role="presentation" cellspacing="0" cellpadding="0" border="0" class="center-on-narrow" style="float:left;">
                      					<tr>
                      						<td class="button-td button-td-primary" style="border-radius: 4px; background: #f7b543;">
                      							<a class="button-a button-a-primary" href="{{ url('/registro/verificar/'.$confirmacion_code) }}" style="background: #f7b543; border: 1px solid #d29428; font-family: sans-serif; font-size: 15px; line-height: 15px; text-decoration: none; padding: 13px 17px; color: #000000; display: block; border-radius: 4px;">Verificar ahora</a>
                      						</td>
                      					</tr>
                      				</table>
                      				<!-- Button : END -->
                      				<br><br><br>
                      				<p style="margin: 0 0 10px 0;">Si el enlace no funciona copia y pega manualmente en tu navegador:</p>
                      				<p style="margin: 0 0 10px 0;">{{ url('/registro/verificar/'.$confirmacion_code) }}</p>
                      			</td>
                      		</tr>
                      	</table>
                      </div>
