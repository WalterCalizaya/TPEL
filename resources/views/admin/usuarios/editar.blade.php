    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-block">
                ...
                <form action="{{ url('/admin/lista-usuario/'.$user->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-sm-10 offset-sm-1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10 form-radio">
                                <div class="radio radio-inline">
                                    <label>
                                    <input type="radio" name="suspendido" id="suspendido" value="0" {{ $user->banneado == '0' ? 'checked="checked"' : '' }}>
                                    <i class="helper"></i>Usuario permitido
                                    </label>
                                </div>
                                <div class="radio radio-inline">
                                    <label>
                                    <input type="radio" name="suspendido" id="suspendido" value="1" {{ $user->banneado == '1' ? 'checked="checked"' : '' }}>
                                    <i class="helper"></i>Usuario baneado
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10 form-radio">
                                <div class="radio radio-inline">
                                    <label>
                                    <input type="radio" name="confirmado" id="confirmado" value="1" {{ $user->confirmado == '1' ? 'checked="checked"' : '' }}>
                                    <i class="helper"></i>Verificado
                                    </label>
                                </div>
                                <div class="radio radio-inline">
                                    <label>
                                    <input type="radio" name="confirmado" id="confirmado" value="0" {{ $user->confirmado == '0' ? 'checked="checked"' : '' }}>
                                    <i class="helper"></i>Sin verificar
                                    </label>
                                </div>
                            </div>
                        </div>
