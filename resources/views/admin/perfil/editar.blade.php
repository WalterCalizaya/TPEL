                ...
                <form action="{{ url('/admin/perfil-admin/modificar') }}" method="post">
                    ...
                    <div class="col-sm-10 offset-sm-1">
                        ...
                        <div class="form-group {{ $errors->has('region') ? ' has-danger' : '' }} row">
                            ...
                            <div class="col-md-10">
                                {!! Form::select('region',$regiones,Auth::user()->distrito->provincia->region->id,["class"=>"region form-control form-control-round fill select2 ",'placeholder' => '-- Región --',"required"=>"","id"=>"region"]) !!}
