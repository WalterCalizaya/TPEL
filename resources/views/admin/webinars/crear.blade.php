	...
	<div class="col-sm-12">
		<div class="card">
			...
			<div class="card-block">
				...
				<form action="{{ url('/admin/webinars') }}" method="post" enctype="multipart/form-data">
					@csrf
					...
					<div class="col-sm-10 offset-sm-1">
                        ...
                        <div class="form-group {{ $errors->has('hora') ? ' has-danger' : '' }} row">
                            ...
                            <div class="col-md-10">
                                <input type="time" class="form-control form-control-round {{ $errors->has('hora') ? ' form-control-danger' : '' }}" id="hora" name="hora" value="{{ old('hora') }}" step="1">
						...
						<div class="form-group {{ $errors->has('shared') ? ' has-danger' : '' }} row">
							...
							<div class="col-md-10">
								...
								@endif
								<h6>Previsualización:</h6><img id="img-shared" src="/resources/img/default.jpg" style="width:400px;height:210px;" alt="Previsualización" class="img-fluid">
							</div>
						</div>
