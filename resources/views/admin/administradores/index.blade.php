                    ...
                    <table id="tacnatelTable" class="table table-striped table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $user->distrito->nombre }}, {{ $user->distrito->provincia->nombre }}</td>
                                <td>
                                    @if ($user->banneado==1)
                                    ...
                                    @else
                                    <span class="label label-warning" data-toggle="tooltip" data-placement="left" data-original-title="Administrador con bloqueo temporal">Bloqueado</span>
                                    @endif
                                </td>
                                @if (Auth::user()->id==1||Auth::user()->id==2)
