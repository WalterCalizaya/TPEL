...
@section('title')
Editar seminario: {{ $evento->titulo }}
@endsection
    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-block">
                ...
                <form action="{{ url('/admin/seminarios/'.$evento->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-sm-10 offset-sm-1">
                        ...
                        <div class="form-group {{ $errors->has('seminario') ? ' has-danger' : '' }} row">
                            ...
                            <div class="col-md-10">
                                @php
                                    $seminario = strstr($evento->titulo, ' - ', true);
                                @endphp
                                <input type="text" class="form-control form-control-round {{ $errors->has('seminario') ? ' form-control-danger' : '' }}" id="seminario" name="seminario" value="{{ $seminario }}">
