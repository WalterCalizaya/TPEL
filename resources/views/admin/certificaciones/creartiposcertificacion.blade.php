	...
	<div class="col-sm-12">
		<div class="card">
			...
			<div class="card-block">
				...
				<form action="{{ url('/admin/tipos-certificacion') }}" method="post" enctype="multipart/form-data">
					@csrf
					...
					<div class="col-sm-10 offset-sm-1">
						...
						<div class="form-group {{ $errors->has('empresa') ? ' has-danger' : '' }} row">
							...
							<div class="col-md-9">
								{!! Form::select('empresa',$empresas,null,['id'=>"empresa",'class'=>"form-control form-control-round fill select2". ($errors->has('empresa') ? ' form-control-danger' : ''),'placeholder' => 'Seleccione...',"required"=>""]) !!}
						...
						<div class="form-group {{ $errors->has('certificacion') ? ' has-danger' : '' }} row">
							...
							<div class="col-md-9">
								<input type="text" class="form-control form-control-round {{ $errors->has('certificacion') ? ' form-control-danger' : '' }}" id="certificacion" name="certificacion" value="{{ old('certificacion') }}">
						...
						<div class="form-group {{ $errors->has('nombrecompleto') ? ' has-danger' : '' }} row">
							...
							<div class="col-md-9">
								<input type="text" class="form-control form-control-round {{ $errors->has('nombrecompleto') ? ' form-control-danger' : '' }}" id="nombrecompleto" name="nombrecompleto" value="{{ old('nombrecompleto') }}">
						...
						<div class="form-group {{ $errors->has('descripcion') ? ' has-danger' : '' }} row">
							...
							<div class="col-md-9">
								<textarea  rows="2" class="form-control {{ $errors->has('descripcion') ? ' form-control-danger' : '' }}" id="descripcion" name="descripcion">{{ old('descripcion') }}</textarea>
