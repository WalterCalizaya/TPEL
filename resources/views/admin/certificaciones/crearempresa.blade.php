	...
	<div class="col-sm-12">
		<div class="card">
			...
			<div class="card-block">
				...
				<form action="{{ url('/admin/empresas-certificadoras') }}" method="post" enctype="multipart/form-data">
					@csrf
					...
					<div class="col-sm-10 offset-sm-1">
						...
						<div class="form-group {{ $errors->has('tipo') ? ' has-danger' : '' }} row">
							...
							<div class="col-md-10">
								<input type="text" class="form-control form-control-round {{ $errors->has('tipo') ? ' form-control-danger' : '' }}" id="tipo" name="tipo" value="{{ old('tipo') }}">
								@if ($errors->has('tipo'))
						...
						<div class="form-group {{ $errors->has('empresa') ? ' has-danger' : '' }} row">
							...
							<div class="col-md-10">
								...
								@endif
								<h6>Previsualización:</h6><img id="img-empresa" src="/resources/img/default.jpg" style="width:269px;height:82px;" alt="Previsualización" class="img-fluid">
							</div>
						</div>
