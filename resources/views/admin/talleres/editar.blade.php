    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-block">
                ...
                <form action="{{ url('/admin/talleres/'.$evento->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-sm-10 offset-sm-1">
                        ...
                        <div class="form-group {{ $errors->has('taller') ? ' has-danger' : '' }} row">
                            ...
                            <div class="col-md-10">
                                @php
                                    $taller = strstr($evento->titulo, ' - ', true);
                                @endphp
                                <input type="text" class="form-control form-control-round {{ $errors->has('taller') ? ' form-control-danger' : '' }}" id="taller" name="taller" value="{{ $taller }}">
