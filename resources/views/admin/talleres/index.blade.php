        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-right">
                    <a href="{{ url('/admin/talleres/create') }}" class="btn waves-effect waves-light btn-primary btn-outline-primary btn-sm"> <i class="icofont icofont-ui-add" style="color:#4680ff;"></i> Agregar taller</a>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($eventos as $evento)
                                <tr>
                                    <td>
                                        {{ $evento->titulo }}
                                        <a href="{{ url('/talleres/').'/'.$evento->slug }}" target="_blank">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ url('/admin/talleres/'.$evento->id.'/edit') }}">
