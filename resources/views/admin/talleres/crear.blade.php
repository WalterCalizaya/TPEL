    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-block">
                ...
                <form action="{{ url('/admin/talleres') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-sm-10 offset-sm-1">
                        ...
                        <div class="form-group {{ $errors->has('taller') ? ' has-danger' : '' }} row">
                            <label class="col-md-2 col-form-label" for="taller">
                                Taller
                            </label>
                            <div class="col-md-10">
                                <input type="text" class="form-control form-control-round {{ $errors->has('taller') ? ' form-control-danger' : '' }}" id="taller" name="taller" value="{{ old('taller') }}">
                        ...
                        <div class="form-group {{ $errors->has('objetivos') ? ' has-danger' : '' }} row">
                            ...
                            <div class="col-md-10">
                                <textarea  rows="10" class="form-control {{ $errors->has('objetivos') ? ' form-control-danger' : '' }}" id="objetivos" name="objetivos">
                                    {{ old('objetivos') ? old('objetivos') : '<p>Este taller es para personas que quieran aprender a configurar equipos MikroTik desde cero, sin mucha teoría. Lo más importante es que aprenderás en un corto tiempo porque el material ofrecido es información de primera mano y lo mejor de todo: te preparamos para las certificaciones oficiales del fabricante MikroTik.</p><p>Consta de ejercicios y laboratorios de casos reales en una red empresarial y dar soluciones a los problemas comunes que se presentan.</p><p>El taller MikroTik se desarrolla con un 70% práctica y 30% de teoría, que proporciona al participante los conocimientos necesarios para la instalación, configuración, administración, monitorización y solución de problemas para redes LAN, utilizando equipamiento MikroTik.</p><p>Al finalizar el taller, el estudiante estará familiarizado con el software RouterOS y con los productos RouterBoard y tendrá la capacidad de configurar, administrar y realizar configuraciones básicas en un router MikroTik y proveer servicios básicos a los clientes.</p>' }}
                                </textarea>
                        ...
                        <div class="form-group {{ $errors->has('conocimientos') ? ' has-danger' : '' }} row">
                            ...
                            <div class="col-md-10">
                                <textarea  rows="10" class="form-control {{ $errors->has('conocimientos') ? ' form-control-danger' : '' }}" id="conocimientos" name="conocimientos">
                                    {{ old('conocimientos') ? old('conocimientos') : '' }}
                                </textarea>
